...
if (select.ind==1) write.csv(output, "results_unknown_var_one_out_of_three_doses.csv")
if (select.ind==2) write.csv(output, "results_unknown_var_two_out_of_three_doses.csv")
